...
In the full course package, read [Chapter 1](../../textbook/module_01_responsibility.md)
before Day 1 and the opening relational-model discussion in
[Chapter 2](../../textbook/module_02_sql.md) before Day 2. The public Week 1-only
package uses the free readings below in place of the unpublished textbook.
