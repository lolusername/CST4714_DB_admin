...
- **Candidate version:** `2.0.0-draft` (first-edition candidate preserved)
- **Status reviewed:** August 26, 2026
...
| Technical local QA | 412-check current local pass; 414-check network-enabled pass over 138 URLs with no confirmed 404/410 and two automated-client refusals manually opened; current 68-cell notebook execution; PostgreSQL fixtures; all-slide/all-PDF visual review; 121-page second-edition Word inspection; responsive HTML checks; EPUB/DOCX/source/checksum checks; official EPUBCheck 5.3.0 pass; focused Atlas/Supabase evidence | COMPLETE FOR LOCAL DRAFT | repeat live links and official EPUBCheck from the approved release commit before tagging |
...
| Cloud/vendor smoke test | bounded live Atlas and Supabase interface checks plus account-free and offline fallbacks; exact limits recorded | PARTIAL | complete any remaining account-gated rows required by the approved release protocol |
...
| First-edition EPUB, W3C EPUBCheck 5.3.0 | complete `1.0.0-rc.1` candidate file | EPUB 3.3 validation completed with zero fatals, errors, warnings, or infos | | PASS CONFORMANCE | local independent validator, August 10, 2026 |
| Second-edition EPUB, W3C EPUBCheck 5.3.0 | complete `2.0.0-draft` candidate file | EPUB 3.3 validation completed with zero fatals, errors, warnings, or infos | | PASS CONFORMANCE | local independent validator, August 26, 2026 |
