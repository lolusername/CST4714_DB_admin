...
The release checklist remains authoritative for actual results. The August 25
current candidate QA passed 412 local checks and 414 network-enabled checks
across 138 unique URLs, with no confirmed 404 or 410 result. The BLS Database
Administrators and Architects page and PDF Association tagged-PDF page refused
the automated client but passed independent browser review. All 214 final slides and all 15
...
the preserved first-edition EPUB passed official W3C EPUBCheck 5.3.0 with zero
messages under EPUB 3.3 rules; and all 90 pages of the preserved first-edition
Word export received visual review. The fuller second edition builds as Word,
tagged PDF, responsive HTML, and EPUB; all 119 Word pages were visually reviewed,
and source/hash/MathML/listing/navigation checks passed. On August 26, 2026, the
second-edition EPUB also passed official W3C EPUBCheck 5.3.0 under EPUB 3.3 rules
with zero fatals, errors, warnings, or informational messages. The check must be
repeated against the eventual approved release commit.
...
- complete credentialed Atlas and remote-Python Supabase notebook routes, plus
  account-gated vendor completion under temporary course/student-role accounts;
