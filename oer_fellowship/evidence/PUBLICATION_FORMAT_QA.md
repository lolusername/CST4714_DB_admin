...
**Historical record.** The September 7, 2026 audit substantially revised the
manuscript and rebuilt its exports. The earlier receipts below apply to their
named versions, not the current files at the same paths. Current revision status
appears in [Fellowship Scope and Quality Evidence](FELLOWSHIP_SCOPE_EVIDENCE.md).
...
- **Candidates:** *Operating Cloud Databases*, versions `1.0.0-rc.1` and
  `2.0.0-draft`
- **Review dates:** August 10 and August 26, 2026
- **EPUB validator:** W3C EPUBCheck 5.3.0, the official EPUB conformance checker
- **Java runtimes:** Eclipse Temurin 21.0.12+8 for the first edition; Java SE
  1.8.0_481 for the second edition
...
## Second-Edition EPUB Addendum

On August 26, 2026, the same official W3C EPUBCheck 5.3.0 distribution was run
against:

`course/textbook/publishing/exports/operating_cloud_databases_second_edition_draft.epub`

The validator again selected EPUB 3.3 rules and completed successfully:
...
**Second-edition EPUBCheck 5.3.0 result: PASS**

This pass applies to the complete second-edition draft containing the same 15
chapters as the canonical source, including 142 MathML elements and all 106
numbered listings. It does not replace reading-system, Pressbooks, LMS, or human
