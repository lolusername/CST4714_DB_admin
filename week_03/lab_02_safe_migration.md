...
[Chapter 4 migration example and Chapter 3 constraint explanations](../Operating_Cloud_Databases.pdf)
as references.
...
**Submit:** `week_03_safe_migration.sql` with the precheck, completed migration,
