...
[Open in GitHub](https://github.com/lolusername/CST4714_DB_admin/blob/main/week_09/lab_01_csv_to_json.md)
...
[Metro Support dataset](materials/datasets/metro_support/README.md).
The files are [users.csv](materials/datasets/metro_support/users.csv),
[tickets.csv](materials/datasets/metro_support/tickets.csv), and
[ticket_events.csv](materials/datasets/metro_support/ticket_events.csv).
