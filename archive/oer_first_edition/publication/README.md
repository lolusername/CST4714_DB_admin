# Legacy First-Edition Publication Package

This directory preserves the first-edition publication workflow and is **not the
assigned textbook**. Use the [second-edition publication workspace](../publication_2e/README.md)
or return to the [course home](../README.md).

This legacy directory turns the first-edition Markdown textbook into portable publication
...
[publication-format QA record](../fellowship/evidence/PUBLICATION_FORMAT_QA.md).
