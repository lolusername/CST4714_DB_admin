...
Use [Chapter 15: Professional Communication Makes Technical Skill Visible](../Operating_Cloud_Databases.pdf).
...
- [Canonical final project](../week_12/materials/assignments/final_project.md)
...
- [Review notebook: Four Tickets, Two Different Totals](materials/notebooks/09_synthesis_review.ipynb)
- [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/lolusername/CST4714_DB_admin/blob/main/week_15/materials/notebooks/09_synthesis_review.ipynb) for the review and optional final-lab example; save a working copy in Drive.

Click **Open in Colab** above to open the notebook directly, or download it for
local Jupyter. It uses Python's SQLite library and synthetic records.
No installation, cloud account, or password is needed. Local Jupyter also works.
...
[canonical final-project requirements](../week_12/materials/assignments/final_project.md). Use prepared,
